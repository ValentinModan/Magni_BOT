...
public class MateIn1
{
    ...
    public void mateIn1(String fen, String expectedMove)
    {
        ...
        assertEquals(expectedMove, actualMove.toString(), "Error calculating fen [" + fen + "] expected " + expectedMove + " actual " + actualMove);
    ...
    private static Stream<Arguments> chessFenAndMoves()
    {
        return Stream.of(
             //   Arguments.of("3r4/kp3p2/p1P1b3/8/P1P3pN/2b1P1B1/4KPP1/1R5R b - - 0 27", "e6c4"),
                ...
                Arguments.of("kr6/P5p1/4p2n/p7/3P1B2/4P3/1R1K1p2/7q w - - 0 36", "a7b8Q"),
