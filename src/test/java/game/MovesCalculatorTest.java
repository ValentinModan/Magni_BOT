...
class MovesCalculatorTest
{
    ...
    void calculateDepth1()
    {
        ...
        Move move1 = MovesCalculator.calculate(board, 10, 2);
    ...
    void calculateDepth1_3_failing_test_to_investigate()
    {
        ...
        Move move1 = MovesCalculator.calculate(board, 6, 8);
    ...
    void calculateDepth1_3_failing_test_to_()
    {
        ...
        Move move1 = MovesCalculator.calculate(board, 6, 6);
    ...
    void computeRandomMoves()
    {
        ...
        board.computePossibleMoves();
        Move bestMove = MovesCalculator.calculate2(board, 1, 7);
    ...
    void randomTest2()
    {
        try {
            ...
            MovesGenerator.makeMoves(board, moves);
            Move bestMove = MovesCalculator.calculate(board, 6, 6);
            System.out.println(bestMove);
        }
        catch (Exception e)
        {
    ...
    void randomTest3()
    {
        ...
        MovesGenerator.makeMoves(board, moves);
        Move bestMove = MovesCalculator.calculate2(board, 2, 3);
        System.out.println(bestMove);
    }
    ...
    void randomTest4()
    {
        ...
        MovesGenerator.makeMoves(board, moves);
        Move bestMove = MovesCalculator.calculate2(board, 10, 1);
        System.out.println(bestMove);
    }
    ...
    void randomTestDepth1Check()
    {
        ...
        MovesGenerator.makeMoves(board, moves);
        Move bestMove = MovesCalculator.calculate(board, 40, 1);
        System.out.println(bestMove);
    }
    ...
    void randomTestRandomDepth()
    {
        ...
        MovesGenerator.makeMoves(board, moves);
        Move bestMove = MovesCalculator.calculate(board, 10, 1);
        System.out.println(bestMove);
    }
