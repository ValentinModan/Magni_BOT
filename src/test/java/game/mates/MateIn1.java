...
public class MateIn1
{
    ...
    public void scholarsMate_depth_search_2()
    {
        ...
        Move bestCalculateMove = CleanMoveCalculator.calculate2(optimizedBoard, 5);
    ...
    public void mateIn1TwoQueens()
    {
        ...
        optimizedBoard.addPiece(firstQueenPosition, new Queen(true));
        optimizedBoard.addPiece(secondQueenPosition,new Queen(true));
        optimizedBoard.addPiece(rook,new Rook(true));
    ...
    public void matein1()
    {
        ...
        Move bestMove = CleanMoveCalculator.calculate2(optimizedBoard,3);
