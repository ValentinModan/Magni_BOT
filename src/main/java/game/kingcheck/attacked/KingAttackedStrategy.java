...
public class KingAttackedStrategy implements AttackedStrategy {
    ...
    private static final List<Movement> kingPossibleMovesList = MovementCalculator.getPossibleMoves(EmptyPiece.KING);
    @Override
    public boolean isAttackingTheKing(OptimizedBoard board)
    {
        ...
        for (Movement movement : kingPossibleMovesList) {
